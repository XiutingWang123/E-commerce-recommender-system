...
USAGE = "<trainset_clicks> <trainset_buys> <testset> <model> <k>"
USAGE_HINT = "model should be a string, k should be an integer."
price_threshold = 50
...
if __name__ == '__main__':
    trainSet_clicks, trainSet_buys, testSet, model, k = getArgs()
